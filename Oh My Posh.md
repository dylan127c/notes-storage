...
OMP 官方推荐使用 [Nerd Font](https://www.nerdfonts.com/font-downloads) 中提供的字体，这些字体均支持 Powerline 以及编程连字，且能更好地兼容 OMP 的主题样式。

这里推荐使用 Cascadia Code 字体的变体 Caskaydia Cove Nerd Font：

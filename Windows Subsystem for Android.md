...
<img src="images/Windows%20Subsystem%20for%20Android.images/Snipaste_2022-08-12_15-04-53.png" alt="Snipaste_2022-08-12_15-04-53" style="zoom: 50%;" />

修改完毕后打开 Microsoft Store 应用商店，它将自动定位到美区的应用市场上。

搜索 Amazon Appstore 应用下载并安装：

<img src="images/Windows%20Subsystem%20for%20Android.images/Snipaste_2022-08-12_15-07-50.png" alt="Snipaste_2022-08-12_15-07-50" style="zoom: 50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812151825728.png" alt="image-20220812151825728" style="zoom: 50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/Snipaste_2022-08-12_15-34-00.png" alt="Snipaste_2022-08-12_15-34-00" style="zoom: 50%;" />

等待安装进度条结束，WSA 安装即完成。

在 Windows 11 系统下，唤醒开始菜单，能够在全部应用列表中，查看到适用于 Android™️ 的 Windows 子系统设置：

<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812153906724.png" alt="image-20220812153906724" style="zoom:50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812163031217.png" alt="image-20220812163031217" style="zoom: 50%;" />

下载并解压到固定目录（便于配置全局环境变量）：

<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812160002367.png" alt="image-20220812160002367" style="zoom: 50%;" />

随后将 abd.exe 所在目录，添加到**系统变量**下的 Path 中：

<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812163246253.png" alt="image-20220812163246253" style="zoom:50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812160152216.png" alt="image-20220812160152216" style="zoom: 50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812160804526.png" alt="image-20220812160804526" style="zoom: 50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812161146589.png" alt="image-20220812161146589" style="zoom:50%;" />

在 Windows 11 系统下，能够在全部应用中找到已安装的 Android 应用入口：

<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812161242068.png" alt="image-20220812161242068" style="zoom:50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20230414193447540.png" alt="image-20230414193447540" style="zoom: 50%;" />
...
<img src="images/Windows%20Subsystem%20for%20Android.images/image-20230421193537358.png" alt="image-20230421193537358" style="zoom:50%;" />

### 现存问题

WSA 安装子系统在使用的过程中，可能会弹出以下连接受限通知：

<img src="images/Windows%20Subsystem%20for%20Android.images/image-20220812165347271.png" alt="image-20220812165347271" style="zoom:50%;" />
